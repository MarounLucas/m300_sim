...
def generate_launch_description():
    ...
    # 1. Caminhos para os arquivos YAML
    ...
    # 2. Argumentos de Lançamento (permite trocar via terminal)
    ...
    # 3. Gravação do ROS Bag
    timestamp = datetime.datetime.now().strftime("%Y_%m_%d-%H_%M_%S")
    bag_path = os.path.join('src', 'm300_sim', 'bags', f'voo_offline_{timestamp}')
